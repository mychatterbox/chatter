...
Short는 블로그 가로폭이 클 경우를 대비해서 안전하게 기본값 75%가 적용된 상태이고, 기본값과 옵션값 수정으로 크기를 변경할 수 있습니다.  
___
...
제 모바일 기기에서 아래 영상이 **'동영상을 재생할 수 없음'** 으로 표시되면서 미리보기가 안됩니다.  
...
여기저기 직접 수정하려면 그걸 일일이 적는 저도 귀찮도 여러분도 귀찮으니까 완성본을 그대로 복붙해서 사용하세요.  
